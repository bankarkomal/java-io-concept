...
public class ObjectInputOutputStreamExample {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Student student = new Student("Omkar",200);

        OutputStream fileOutputStream = new FileOutputStream("C:\\Users\\Admin\\IdeaProjects\\java-io-concept-2\\byte-streaming\\src\\Objects.txt");
        ...
        InputStream fileInputStream = new FileInputStream("C:\\Users\\Admin\\IdeaProjects\\java-io-concept-2\\byte-streaming\\src\\Objects.txt");
